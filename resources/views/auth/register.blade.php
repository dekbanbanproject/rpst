			...
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
                    ...
                    <img src="img/logo/rpst.jpg" alt="IMG"><br><br>
                        <h5>โรงพยาบาลส่งเสริมสุขภาพตำบล</h5><br>
                        {{-- <h4>บ้านวังม่วย</h4> --}}
                    </center>
				...
				<form class="login100-form validate-form" method="POST" action="{{ route('login') }}">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Name">
                        <input id="name" type="text" placeholder="ชื่อ-นามสกุล" class="input100 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
                        <input id="password" type="password" placeholder="รหัสผ่าน" class="input100 @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="container-login100-form-btn">
                        ...
                        <button type="submit" class="login100-form-btn">ลงทะเบียน
                            <!-- {{ __('Login') }} -->
                        </button>
					</div>
