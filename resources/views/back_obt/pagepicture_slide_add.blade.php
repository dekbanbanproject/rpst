        ...
        <div class="content-wrapper">  
            ...
            <div class="card border-info bg-transparent">
                <div class="card-content"> 
                    ...
                    <div class="card-body">
                        <form action="{{ route('obt.upload_store') }}" method="post" enctype="multipart/form-data" >
                            @csrf   

                        <div class="row">
                                    {{-- <img src="{{ asset('img/s1.jpg')}}" id="image_upload_preview" alt="Image" class="img-thumbnail" style="height:350px; width:1200px;"> --}}
                                    <div class="col-lg-12">
                        ...
                        {{-- <div class="row">
                            <div class="col-md-12 mb-12"><br>
                                <div class="form-group">
                                    <label style=" font-family: 'Kanit', sans-serif;">ชื่อรูปภาพ</label>
                                    <input type="text" class="form-control round mb-1 mt-1 border-success" id="iconLeft10" placeholder="ชื่อรูปภาพ" name="filename" >                                                    
                                </div>                               
                            </div>
                        </div>   --}}
                    </div>
                    <div class="card-footer" align="right">
                        <a href="{{url('back_obt/pagepicture_slide')}}" class="btn grey btn-outline-danger" data-dismiss="modal"><i class="ft-power mr-1"></i>Close</a>
