                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-right">
                                        <h5 class="text-muted text-bold-500"> OPD Scan</h5>
                                        <h3 class="text-bold-600">{{$opdcount}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="card-content">
                          <div class="card-body">
                              <div class="media d-flex">
                                  ...
                                  <div class="media-body text-right">
                                      <h5 class="text-muted text-bold-500">OPD Scan Today</h5>
                                      <h3 class="text-bold-600">{{$opdcountL}}</h3>
                                  </div>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="card-content">
                          <div class="card-body">
                              <div class="media d-flex">
                                  ...
                                  <div class="media-body text-right">
                                      <h5 class="text-muted text-bold-500"> IPD Scan</h5>
                                      <h3 class="text-bold-600">{{$ipdcount}}</h3>
                                  </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-right">
                                        <h5 class="text-muted text-bold-500">IPD Scan Today </h5>
                                        <h3 class="text-bold-600">{{$ipdcountL}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Scan Opd</h4>
