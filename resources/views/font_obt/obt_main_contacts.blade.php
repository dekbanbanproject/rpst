            ...
            <div class="col-lg-9  ">                
                <div class="card border-top-blue border-top-3 border-bottom-blue border-left-blue border-left-1 border-right-blue border-right-1 border-bottom-1 box-shadow-3 pull-up">
                    <div class="card-header shadow-lg">
                         <label for="" style="font-size:19px;color:rgb(240, 15, 8)">ร้องเรียน</label>
                    </div>
                        ...
                        <form action="{{ route('obt.obt_main_contacts_save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset class="form-group position-relative ">
                                            <label for="" style="font-size:19px;color:rgb(63, 37, 179)">ชื่อ-นามสกุล</label>
                                            <input type="text" class="form-control round mb-1 mt-1 border-success" id="iconLeft10" placeholder="ชื่อ-นามสกุล" name="con_name" >                                                    
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="form-group position-relative ">
                                            <label for="" style="font-size:19px;color:rgb(63, 37, 179)">อีเมล์</label>
                                            <input type="text" class="form-control round mb-1 mt-1 border-success" id="iconLeft10" placeholder="อีเมล์" name="con_email" >                                                    
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <fieldset class="form-group position-relative ">
                                            ...
                                            <input type="text" class="form-control round mb-1 mt-1 border-success" id="iconLeft10" placeholder="ชื่อเรื่อง" name="con_title" >                                                    
                                        </fieldset>
                                    </div>  
                                    <div class="col-md-4">
                                        <fieldset class="form-group position-relative ">
                                            <label for="" style="font-size:19px;color:rgb(63, 37, 179)">เบอร์โทร</label>
                                            <input type="text" class="form-control round mb-1 mt-1 border-success" id="iconLeft10" placeholder="เบอร์โทร" name="con_tel" >                                                    
                                        </fieldset>
                                    </div>                                  
                                </div>
                                ...
                                <fieldset class="form-group position-relative ">
                                    ...
                                    <textarea class="form-control" id="con_message" name="con_message" rows="10"></textarea>    
                                </fieldset>
                            </div>
                            <div class="card-footer" align="right">
                                <a href="{{url('/')}}" class="btn btn-outline-danger btn-min-width btn-glow mr-1 mb-1" data-dismiss="modal"><i class="ft-power mr-1"></i>Close</a>
