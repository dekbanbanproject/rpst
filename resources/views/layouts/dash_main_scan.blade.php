                    ...
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <li class="dropdown nav-item mega-dropdown d-none d-lg-block"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Menu</a>
                            <ul class="mega-dropdown-menu dropdown-menu row p-1">                             
                                <li class="col-md-5 px-2">
                                    <h6 class="font-weight-bold font-medium-2 ml-1">Scan Panel</h6>
                                    <ul class="row mt-2">
                                        <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="{{url('backend/ipd/scan_ipd')}}" target="_blank"><i class="la la-inbox font-large-2 text-info mr-1"></i> <p class="font-medium-2 mt-25 mb-50">Scan Ipd</p></a></li>
                        ...
                        {{-- <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="ficon ft-search"></i></a>
                            <div class="search-input">
                                <input class="input dataTables_wrapper dt-bootstrap" type="text" placeholder="ค้นหา..." tabindex="0" data-search="template-list">
       ...
       <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                {{-- <li class="active"><a href="{{url('scan_dashboard')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="Dashboard Hospital">Dashboard Hospital</span></a> --}}
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-user"></i><span class="menu-title" data-i18n="Appointment">Menu </span></a>
                    <ul class="menu-content">                       
                        <li><a class="menu-item" href="{{url('opd')}}"><i></i><span>Scan Opd</span></a></li>  
                        <li><a class="menu-item" href="{{url('')}}"><i></i><span>Scan Ipd</span></a></li>  
                    </ul>
                </li>
