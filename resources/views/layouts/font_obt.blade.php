    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a href="{{url('/')}}" class="navbar-brand nav-link"><img src="{{ asset('img/logo/logod.png') }}" alt="branding logo" style="height:40px; width:40px;"> <h3 class="brand-text">Dekbanbanproject</h3></a>
        ...
        <div class="navbar-container content">
            <div id="navbar-mobile1" class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav mr-auto">
                    <li class="nav-item d-none d-lg-block mr-2"><a class="nav-link nav-link-expand" href="#"><i class="ficon ft-maximize"></i></a></li>
                    <li class="nav-item d-none d-md-block"><a class="nav-link nav-menu-main" href="{{url('/')}}"><i class="ft-home mr-2" style="font-size:22px;color:rgb(26, 136, 240)"></i><label style="font-size:22px;color:rgb(26, 136, 240)">หน้าหลัก</label></a></li>
                </ul>
