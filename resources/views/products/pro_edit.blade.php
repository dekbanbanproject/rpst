...
<div class="container-fluid">
    ...
    <form method="post" action="{{route('Pro.pro_update')}}" enctype="multipart/form-data" novalidate="novalidate">
    @csrf

    <input type="hidden" value="{{$Pros->id}}" name ="id" id="id" class="form-control input-sm"> 
    <div class="card mb-3" style="max-width: 2350px;">
        <div class="row no-gutters">
            <div class="col-md-3">  <br>             
                <div class="form-group text-center">                   
                        <img src="{{ asset('img/product/' .$Pros->img)}}" id="add_upload_preview" alt="Image" class="img-thumbnail" style="height:300px; width:300px;">
                </div>
            ...
            <div class="card-body">   
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label for="validationServer01">Product Code</label>
                            <input type="text" class="form-control" value="{{$Pros->product_code}}" id="product_code" name="product_code" required>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="validationServer02">Product Name</label>
                            <input class="form-control"id="product_name" name="product_name" value="{{$Pros->product_name}}" required>
                            <div class="valid-feedback">
                                Product Name!
                            </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="validationServerPrice">Price</label>
                            <input class="form-control" id="product_price" name="product_price" value="{{$Pros->product_price}}" required>
                            <div class="valid-feedback">
                                Product Price!
                            </div>
                    </div>
                        ...
                        <select id="units_id" name="units_id" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;">
                            <option value="">--เลือกหน่วยนับ--</option>
                                @foreach ($units as $unit)
                                    @if($unit ->UNITS_ID == $Pros->units_id )
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" row="3" value="{{$Pros->description}}">{{$Pros->description}} </textarea>                                      
                    </div>                     
                </div>                        
            </div>
        </div>
