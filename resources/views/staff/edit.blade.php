              ...
              <div class="col-md-12">
                ...
                <div class="card-p card-info">
                  <div class="card-header shadow lg">
                    <h3 class="card-title">แก้ไขรายชื่อ <small>เจ้าหน้าที่</small></h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="{{ route('staff.update',$data->id) }}" role="form" id="quickForm"  method="POST" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="form-row">
                            <div class="col-sm-4 text-left">
                                <div class="form-group">
                                    ...
                                    <img src="data:image/png;base64,{{ chunk_split(base64_encode($data->img)) }}" id="add_upload_preview" alt="Image" class="img-thumbnail" style="height:250px; width:260px;">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" name="lname" class="form-control" id="lname" placeholder="lname" value="{{$data->lname }}">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <select name ="position" id="position" class="form-control">
                                    <option value="">เลือก</option>
                                        ...
                                        @if($position->POSITION_ID == $data->position)
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" name="cid" class="form-control" id="cid" placeholder="Enter Line Token"  value="{{$data->cid }}">
                              </div>
                              <div class="form-group col-md-6">
                                <label for="facebook">facebook</label>
                                <input type="text" name="facebook" class="form-control" id="facebook" placeholder="Enter facebook" value="{{$data->facebook }}">
                              </div>
                              </div>
                          ...
                          @if((Auth::user()->status) == 'SUPER_ADMIN')
                                ...
                                <select name ="STORE" id="STORE" class="form-control">
                                            <option value="">เลือก</option>
                                                ...
                                                @if($store->LOCATE_ID == $data->store_id)
                                                    <option value="{{ $store ->LOCATE_ID }}" selected>{{ $store->LOCATE_NAME}}</option>
                                                    @else
                                ...
                                <input type="text" name="linetoken" class="form-control" id="linetoken" placeholder="Enter Line Token" value="{{$data->linetoken }}">
