        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">เพิ่ม Supplier</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<section class="col-md-12">
    <div class="card-p shadow lg">
        <div class="card-header shadow lg">
            <h5 class="float-sm-left  font-weight-bold text-success">เพิ่ม Supplier</h5>
            ...
            <form action="{{ url('supplier/store/'.(Auth::user()->store_id).'/'.(Auth::user()->id)) }}" method="POST" enctype="multipart/form-data" >
                @csrf
                            <div class="form-row">

                                    <div class="form-group col-md-8 mb-8 text-left">
                                        <label for="sup_name">ชื่อ Supplier</label>
                                        <input name ="sup_name" id="sup_name" class="form-control" required>
                                    ...
                                    <div class="form-group col-md-4 mb-4 text-left">
                                        ...
                                        <input name ="sup_tel" id="sup_tel" class="form-control" required>
                                    ...
                                    <div class="form-group col-md-12 mb-12 text-left">
                                       ...
                                       <textarea name="sup_address" id="sup_address" class="form-control" rows="4" required></textarea>
                    ...
                    <div class="card-footer shadow lg">
                        <div class="form-row">
                            ...
                            <input class="float-sm-right btn btn-info" id="btn1" type="submit" value="Submit"><i class="fa fa-save fa-sm text-white-50" style="font-size:15px "></i>&nbsp;&nbsp; </input>
                            </div>
                        </div>
                    </div>
                </div>
